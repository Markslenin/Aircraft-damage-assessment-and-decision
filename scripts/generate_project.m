...
add_line(modelName, 'Sensor_Output_Bus/1', 'Online Damage Identifier/1', 'autorouting', 'on');
add_line(modelName, 'theta_d/1', 'Online Damage Identifier/2', 'autorouting', 'on');
...
add_line(blockPath, 'IdentifierBridge/1', 'eta_hat/1', 'autorouting', 'on');
end
